...
int ViewConsoleBoardGame::draw(int num)
{
	...
	case 3: system("cls");
		cout << "Choose option : \n\t1.low level\n\t2.hight level\n\t3.Exit" << endl; break;
	case 4: cout << "Choose one option:\n\t1.Play Again\n\t2.Exite" << endl; break;
	case 5: cout << "Choose correct option" << endl; break;
	case 6: system("cls");
		cout << "Catch The Bunny" << endl;
		cout << "how many moves you allow for this game? "; break;
	}
	int x;
	if(num != 6) 
		cout << "Number option: ";
...
{ 
	...
	if (size == 3)
		...
		cout << "Welcome to Catch The Bunny! \n User is 'P' & Computer is 'R'" << endl;

	switch (state) 
	{
	case PlayWins:			cout << "PlayWins" << endl;		break;
	case ComputerWins:		cout << "ComputerWins" << endl; break;
	case Tie:				cout << "Tie" << endl;			break;
	case InProgress:		cout << "InProgress" << endl;	break;
	}
...
Move ViewConsoleBoardGame::chooseMove() 
{
	...
	else
	{
		...
		switch (option)
		{
		case 1: coordinateX--; break;
		case 2: coordinateX++; break;
		case 3: coordinateY++; break;
		case 4: coordinateY--; break;
		default: cout << "You must choose an impressive side" << endl; break;
		}
	}
